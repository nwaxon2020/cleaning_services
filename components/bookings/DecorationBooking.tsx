...
//   FaGavel, FaLayerGroup, FaLock, FaTimes
// } from 'react-icons/fa';
...
//   const ADMIN_PASSCODE = "1234"; // Change this to your desired code
...
//                       {/* WIPE BUTTON: Only in Approved or Cancelled tabs */}
...
//                 <FaLock size={24} />
//               </div>
//               <h2 className="text-xl font-black text-slate-900 uppercase tracking-tighter mb-2">Wipe Firebase Record?</h2>
//               <p className="text-slate-500 text-sm font-bold mb-8 uppercase tracking-wide">Enter Admin Passcode to authorize permanent deletion.</p>
...
//                 placeholder="••••"
//                 className="w-full bg-slate-50 border-2 border-slate-100 rounded-2xl py-4 text-center text-2xl font-black tracking-[1em] focus:border-red-500 focus:outline-none transition-all mb-6"
//                 autoFocus
//               />
